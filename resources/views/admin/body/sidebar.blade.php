      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"><a class="nav-link" href="">Add Post</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="charts">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="">All Video</a></li>
            <li class="nav-item"> <a class="nav-link" href="">Add Video</a></li>
          </ul>
        </div>
      </li>
      {{-- <li class="nav-item">
