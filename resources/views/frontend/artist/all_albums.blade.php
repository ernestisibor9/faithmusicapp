...
<body>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url({{ asset('frontend/img/bg-img/add3.gif') }});">
    ...
    <div class="add-area mb-100">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="adds">
                        <a href="#"><img src="{{ asset('frontend/img/bg-img/adds.gif') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
